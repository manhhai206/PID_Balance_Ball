...
PID_params = {
    'x': {'error': 0, 'previous_error': 0, 'PID_i': 0, 'PID_p': 0, 'PID_d': 0, 'kp': 2.4, 'kd': 40, 'ki': 0.12, 'period': 1},
    'y': {'error': 0, 'previous_error': 0, 'PID_i': 0, 'PID_p': 0, 'PID_d': 0, 'kp': 2.4, 'kd': 40, 'ki': 0.12, 'period': 1}
}
